...
def model_svhn():
    ...
    checkpoint = ModelCheckpoint(filepath='Networks/model_svhn.hdf5',monitor='val_acc',mode='auto',save_best_only='True')
    model.fit(X_train, Y_train, batch_size=64, epochs=3,validation_data=(X_test, Y_test),callbacks=[checkpoint])
    model=load_model('Networks/model_svhn.hdf5')
