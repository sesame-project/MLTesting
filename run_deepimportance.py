...
from utils_ini import load_MNIST, load_CIFAR
from utils_ini import filter_val_set, get_trainable_layers
from utils_ini import generate_adversarial, filter_correct_classifications
...
if __name__ == "__main__":
    ...
    model_path     = args['model'] if args['model'] else 'Networks/LeNet5'
