...
train_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "dataset/SVHN", "train_32x32.mat")
test_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "dataset/SVHN", "test_32x32.mat")
extra_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "dataset/SVHN", "extra_32x32.mat")
