...
DeepLab: Deep Labelling for Semantic Image Segmentation
 for dense pixel labeling tasks in TensorFlow2 at https://github.com/google-research/deeplab2.
...
def vis_segmentation(image, seg_map, FULL_COLOR_MAP,LABEL_NAMES):
  ...
  path= '../masks/masksemantic.jpeg'

  # seg_image = seg_image.resize((214, 214))
  cv2.imwrite(path, seg_image)

  create_separate_mask(path)
...
def run_visualization(url, MODEL,FULL_COLOR_MAP,LABEL_NAMES):
...
def get_mask(image_url):
    ...
    resized_im, seg_map=run_visualization(image_url, MODEL,FULL_COLOR_MAP,LABEL_NAMES)
...
def create_separate_mask(path):
    ...
    # for mask_file in glob.glob(path):
        ...
        for i in range(nb_labels):
            ...
            file_name = "iteration.jpeg"
            # file_copy = os.path.join(path, file_name + "_" + str(i+1) +".png")
            cv2.imwrite(file_name, separate_mask)
...
if __name__ == "__main__":
    ...
    IMAGE_URL = 'https://thumbs.dreamstime.com/z/happy-smiling-man-standing-his-black-classic-motorcycle-black-helmet-jacket-front-portrait-man-black-clothes-122276388.jpg'

    # 'https://www.gizmodo.com.au/wp-content/uploads/sites/2/2022/07/07/96b0f8c1fc7546deab323b0f6ba9f33a.jpg?quality=80&resize=832,468'
    # '
    # @param {type:"string"}
    image_url = IMAGE_URL or _SAMPLE_URL % SAMPLE_IMAGE
    resized_im, seg_map=get_mask(image_url)
    path= '../masks/masksemantic.jpeg'
    create_separate_mask(path)
    print("done")
